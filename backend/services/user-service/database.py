"""
Database connection helper per User Service
"""
...
if DB_POOL_MIN_SIZE == 0 and DB_POOL_MAX_SIZE == 10:
...
async def ensure_database_initialized():
    ...
    if not _db_initialized:
        try:
            ...
            print("✅ Database connesso (User Service - lazy init)")
        except Exception as e:
            print(f"⚠️ Errore connessione database (User Service): {e}")
...
async def close_database():
    ...
    try:
        ...
        _db_initialized = False
        print("✅ Database disconnesso (User Service)")
    except Exception as e:
        print(f"⚠️ Errore disconnessione database (User Service): {e}")
